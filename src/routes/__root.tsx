    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="btn-base btn-outline text-foreground">
            Go home
          </a>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "House Of Nyibiba | Guest House in Vosloorus, Boksburg" },
      {
        name: "description",
        content:
          "House Of Nyibiba is a boutique guest house in Vosloorus, Boksburg offering air-conditioned rooms, kitchenettes, a hot tub, free WiFi and secure parking.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: site.name,
          description:
            "Boutique guest house accommodation in Vosloorus, Boksburg, South Africa.",
          telephone: "+27686714955",
          address: {
            "@type": "PostalAddress",
            streetAddress: "21764/160 Kenyo St, Vosloorus Ext 6",
